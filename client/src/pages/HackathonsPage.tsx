                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {activeHackathon?.id === h.id && (
                      <span
                        className="px-1.5 py-0.5 rounded text-white font-semibold uppercase flex-shrink-0"
                  ...
                  {h.description && (
                    <p className="text-caption mt-0.5 truncate-2">{h.description}</p>
                  )}
                </div>
                <span
                  className={cn(
                    'badge flex-shrink-0',
                    h.status === 'ACTIVE' ? 'badge-checked_in' :
                    h.status === 'ENDED' ? 'badge-ended' : 'badge-draft'
                  )}
                >
                  {h.status}
                </span>
