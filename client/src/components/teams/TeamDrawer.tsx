...
import {
  X, Phone, UserCheck, RotateCcw, MessageSquare, Edit2, Check,
...
export function TeamDrawer({ team, onClose }: { team: Team; onClose: () => void }) {
  ...
  useEffect(() => {
    ...
    api.get<any[]>(`/hackathons/${activeHackathon.id}/coordinators`)
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium truncate" style={{ fontSize: 14 }}>
                      ...
                      {p.isLeader && (
                        <span
                          className="ml-2 px-1.5 py-0.5 rounded text-white font-semibold uppercase"
                          style={{ fontSize: 9, letterSpacing: '0.05em', background: '#0A0A0A' }}
                        >
                          Leader
                        </span>
                      )}
                    ...
                    {p.email && (
                      <p className="text-caption truncate">{p.email}</p>
                    )}
                  </div>
                  {p.phone && (
                    <a
          ...
          <div>
            ...
            {editingRoom ? (
              <div className="flex gap-2">
                ...
                />
                <button className="btn btn-primary btn-icon" onClick={saveRoom}>
              ...
              <div className="card px-4 py-3">
                ...
                {team.projectUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    className="flex items-center gap-1 text-caption mt-1 transition-colors duration-100"
