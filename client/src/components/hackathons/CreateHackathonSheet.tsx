      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <Zap className="w-4.5 h-4.5" style={{ color: 'var(--bg)', width: 18, height: 18 }} strokeWidth={2.5} />
            </div>
            <div>
          ...
          <div>
            ...
            <select value={form.mode} onChange={f('mode')} className="input">
              <option value="PREDEFINED">
                Predefined — teams choose a problem
              </option>
              <option value="ON_SPOT">
                On-spot — coordinators assign problems
              </option>
            </select>
          </div>
        </div>
